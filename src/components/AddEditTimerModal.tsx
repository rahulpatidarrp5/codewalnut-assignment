...
interface AddEditTimerModalProps {
  isOpen: boolean;
  onClose: () => void;
  timer?: Timer | null; // Optional: If provided, the modal is in edit mode
}
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (timer) {
      ...
      editTimer(timer.id, {
        ...
        remainingTime: timer.isRunning ? timer.remainingTime : totalSeconds,
      });
    } else {
      // Add new timer
      addTimer({
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <input
              ...
              className={`${
                touched.title && !isTitleValid
                  ? 'border-[2px] p-1 rounded-md border-red-500 w-full'
                  : 'border-[2px] p-1 rounded-md border-gray-300 w-full'
              }`}
          ...
          <div>
            ...
            <textarea 
              ...
              rows={3}
              className="border-[2px] p-1 rounded-md border-gray-300 w-full"
