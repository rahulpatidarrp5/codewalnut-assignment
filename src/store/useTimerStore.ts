...
// Load timers from localStorage or initialize with an empty array
const initialState = {
...
// Middleware to sync state changes to localStorage
...
// Custom hook to interact with the timer store
